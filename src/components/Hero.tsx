...
const Hero = () => {
  ...
  React.useEffect(() => {
    const fetchMovies = async () => {
      try {
        ...
        console.error("Error fetching movies:", err); // Debugging log
  ...
  const movie = featuredMovies[currentMovie] || featuredMovies[0];
  ...
  return (
    <div className="relative h-[90vh] bg-gradient-to-b from-transparent to-black">
      <div
        ...
        style={{
          backgroundImage: movie ? `url('${movie.image}')` : undefined,
        }}
      >
